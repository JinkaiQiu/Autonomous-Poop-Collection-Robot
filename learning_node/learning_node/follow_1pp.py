...
class FollowBall(Node):
    ...
    def __init__(self):
        ...
        self.subscription = self.create_subscription(
            ...
            10)
        self.publisher_ = self.create_publisher(Twist, '/cmd_vel', 10) # The create_publisher function creates a publisher for the topic '/cmd_vel' of type Twist. 
    ...
    def listener_callback(self, msg):
        f = self.filter_value
        self.target_val = self.target_val * f + msg.point.x * (1-f)
        self.target_dist = self.target_dist * f + msg.point.z * (1-f)
