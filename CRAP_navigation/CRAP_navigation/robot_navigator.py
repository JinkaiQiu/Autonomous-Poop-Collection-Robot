...
# Modified by Jinkai Qiu for CRAP project
...
class BasicNavigator(Node):
    ...
    def __init__(self, node_name='basic_navigator'):
        ...
        # Added
        self.drive_on_heading_client = ActionClient(self,DriveOnHeading,'driveonheading')
    ...
    # Added 
    def driveonheading(self, drive_dist=0.15, drive_speed=0.025, time_allowance=10):
        ...
        goal_msg.target = Point(x=float(drive_dist))
        goal_msg.speed = drive_speed
        goal_msg.time_allowance = Duration(sec=time_allowance)

        self.info(f'Driving on heading {goal_msg.heading} at {goal_msg.speed} m/s....')
